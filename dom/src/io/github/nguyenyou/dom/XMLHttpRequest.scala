...
class XMLHttpRequest extends EventTarget {
  ...
  var ontimeout: js.Function1[ProgressEvent, ?] = js.native
  ...
  var onload: js.Function1[ProgressEvent, ?] = js.native
  ...
  var onprogress: js.Function1[ProgressEvent, ?] = js.native
  var onabort: js.Function1[ProgressEvent, ?] = js.native
  ...
  var onloadend: js.Function1[ProgressEvent, ?] = js.native

  /** The upload process can be tracked by adding an event listener to upload. */
  var upload: XMLHttpRequestEventTarget = js.native
  var onerror: js.Function1[ProgressEvent, ?] = js.native
  var onloadstart: js.Function1[ProgressEvent, ?] = js.native
}
