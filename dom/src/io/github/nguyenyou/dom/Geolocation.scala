...
trait Geolocation extends js.Object {
  ...
  def getCurrentPosition(successCallback: js.Function1[Position, ?], errorCallback: js.Function1[PositionError, ?],
      options: PositionOptions = js.native): Unit = js.native

  /** The Geolocation.getCurrentPosition() method is used to get the current position of the device. */
  def getCurrentPosition(successCallback: js.Function1[Position, ?]): Unit = js.native
