...
trait ApplicationCache extends EventTarget {
  ...
  var ondownloading: js.Function1[Event, ?] = js.native
  var onprogress: js.Function1[ProgressEvent, ?] = js.native
  var onupdateready: js.Function1[Event, ?] = js.native
  var oncached: js.Function1[Event, ?] = js.native
  var onobsolete: js.Function1[Event, ?] = js.native
  var onerror: js.Function1[ErrorEvent, ?] = js.native
  var onchecking: js.Function1[Event, ?] = js.native
  var onnoupdate: js.Function1[Event, ?] = js.native
