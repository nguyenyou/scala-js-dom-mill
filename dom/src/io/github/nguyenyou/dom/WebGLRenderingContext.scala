...
object WebGLRenderingContext {
  ...
  /** Identifies texture unit 8. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE8 = 0x84C8

  /** Identifies texture unit 9. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE9 = 0x84C9

  /** Identifies texture unit 10. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE10 = 0x84CA

  /** Identifies texture unit 11. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE11 = 0x84CB

  /** Identifies texture unit 12. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE12 = 0x84CC

  /** Identifies texture unit 13. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE13 = 0x84CD

  /** Identifies texture unit 14. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE14 = 0x84CE

  /** Identifies texture unit 15. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE15 = 0x84CF

  /** Identifies texture unit 16. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE16 = 0x84D0

  /** Identifies texture unit 17. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE17 = 0x84D1

  /** Identifies texture unit 18. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE18 = 0x84D2

  /** Identifies texture unit 19. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE19 = 0x84D3

  /** Identifies texture unit 20. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE20 = 0x84D4

  /** Identifies texture unit 21. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE21 = 0x84D5

  /** Identifies texture unit 22. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE22 = 0x84D6

  /** Identifies texture unit 23. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE23 = 0x84D7

  /** Identifies texture unit 24. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE24 = 0x84D8

  /** Identifies texture unit 25. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE25 = 0x84D9

  /** Identifies texture unit 26. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE26 = 0x84DA

  /** Identifies texture unit 27. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE27 = 0x84DB

  /** Identifies texture unit 28. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE28 = 0x84DC

  /** Identifies texture unit 29. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE29 = 0x84DD

  /** Identifies texture unit 30. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
  final val TEXTURE30 = 0x84DE

  /** Identifies texture unit 31. This texture unit ''may not exist in a given implementation''. You should examine
    * MAX_COMBINED_TEXTURE_IMAGE_UNITS before using it.
    */
...
class WebGLRenderingContext extends js.Object {
  ...
  /** Loads a a target into a [[WebGLBuffer]].
    *
    * @param target
    *   the target to bind the buffer to. May be [[WebGLRenderingContext.ARRAY_BUFFER]] or
  ...
  /** Loads a the active texture unit into a [[WebGLTexture]].
    *
    * @param target
    *   the target to bind to. Must be [[WebGLRenderingContext.TEXTURE_2D]] or
  ...
  /** Specifies the equation used for RGB and Alpha blending.
    *
    * @param mode
    *   blend equation to use. Can be one of [[WebGLRenderingContext.FUNC_ADD]],
    *   [[WebGLRenderingContext.FUNC_SUBTRACT]], or [[WebGLRenderingContext.FUNC_REVERSE_SUBTRACT]]
    */
  ...
  /** Specifies the equation used for RGB and Alpha blending separately.
    *
    * @param modeRGB
    *   blend equation to use for RGB components. Can be one of [[WebGLRenderingContext.FUNC_ADD]],
    *   [[WebGLRenderingContext.FUNC_SUBTRACT]], or [[WebGLRenderingContext.FUNC_REVERSE_SUBTRACT]]
    * @param modeAlpha
    *   blend equation to use for alpha components. Can be one of [[WebGLRenderingContext.FUNC_ADD]],
    *   [[WebGLRenderingContext.FUNC_SUBTRACT]], or [[WebGLRenderingContext.FUNC_REVERSE_SUBTRACT]]
    */
  ...
  /** Specifies how the blending factors are computed for source and destination pixels.
    *
    * @param sfactor
    *   The source blending factors. May be one of [[WebGLRenderingContext.ZERO]], [[WebGLRenderingContext.ONE]],
    *   [[WebGLRenderingContext.SRC_COLOR]], [[WebGLRenderingContext.ONE_MINUS_SRC_COLOR]],
    *   [[WebGLRenderingContext.DST_COLOR]], [[WebGLRenderingContext.ONE_MINUS_DST_COLOR]],
    *   [[WebGLRenderingContext.SRC_ALPHA]], [[WebGLRenderingContext.ONE_MINUS_SRC_ALPHA]],
    *   [[WebGLRenderingContext.DST_ALPHA]], [[WebGLRenderingContext.ONE_MINUS_DST_ALPHA]],
    *   [[WebGLRenderingContext.CONSTANT_COLOR]], [[WebGLRenderingContext.ONE_MINUS_CONSTANT_COLOR]],
    *   [[WebGLRenderingContext.CONSTANT_ALPHA]], [[WebGLRenderingContext.ONE_MINUS_CONSTANT_ALPHA]], or
    *   [[WebGLRenderingContext.SRC_ALPHA_SATURATE]]. Initially this value is [[WebGLRenderingContext.ONE]].
    * @param dfactor
    *   The destination blending factors. May be one of [[WebGLRenderingContext.ZERO]], [[WebGLRenderingContext.ONE]],
    *   [[WebGLRenderingContext.SRC_COLOR]], [[WebGLRenderingContext.ONE_MINUS_SRC_COLOR]],
    *   [[WebGLRenderingContext.DST_COLOR]], [[WebGLRenderingContext.ONE_MINUS_DST_COLOR]],
    *   [[WebGLRenderingContext.SRC_ALPHA]], [[WebGLRenderingContext.ONE_MINUS_SRC_ALPHA]],
    *   [[WebGLRenderingContext.DST_ALPHA]], [[WebGLRenderingContext.ONE_MINUS_DST_ALPHA]],
    *   [[WebGLRenderingContext.CONSTANT_COLOR]], ` ONE_MINUS_CONSTANT_COLOR`, [[WebGLRenderingContext.CONSTANT_ALPHA]],
    *   or [[WebGLRenderingContext.ONE_MINUS_CONSTANT_ALPHA]]. This value is initially [[WebGLRenderingContext.ZERO]].
    */
  ...
  /** Specifies how the blending factors are computed for source and destination pixels, separately for alpha and RGB.
    *
    * @param srcRGB
    *   The source blending factor for RGB. May be one of [[WebGLRenderingContext.ZERO]], [[WebGLRenderingContext.ONE]],
    *   [[WebGLRenderingContext.SRC_COLOR]], [[WebGLRenderingContext.ONE_MINUS_SRC_COLOR]],
    *   [[WebGLRenderingContext.DST_COLOR]], [[WebGLRenderingContext.ONE_MINUS_DST_COLOR]],
    *   [[WebGLRenderingContext.SRC_ALPHA]], [[WebGLRenderingContext.ONE_MINUS_SRC_ALPHA]],
    *   [[WebGLRenderingContext.DST_ALPHA]], [[WebGLRenderingContext.ONE_MINUS_DST_ALPHA]],
    ...
    *   [[WebGLRenderingContext.SRC_ALPHA_SATURATE]]. Initially this value is [[WebGLRenderingContext.ONE]].
    * @param dstRGB
    *   The destination blending factor for RGB. May be one of [[WebGLRenderingContext.ZERO]],
    *   [[WebGLRenderingContext.ONE]], [[WebGLRenderingContext.SRC_COLOR]],
    *   [[WebGLRenderingContext.ONE_MINUS_SRC_COLOR]], [[WebGLRenderingContext.DST_COLOR]],
    *   [[WebGLRenderingContext.ONE_MINUS_DST_COLOR]], [[WebGLRenderingContext.SRC_ALPHA]],
    *   [[WebGLRenderingContext.ONE_MINUS_SRC_ALPHA]], [[WebGLRenderingContext.DST_ALPHA]],
    *   [[WebGLRenderingContext.ONE_MINUS_DST_ALPHA]], [[WebGLRenderingContext.CONSTANT_COLOR]], `
    *   ONE_MINUS_CONSTANT_COLOR`, [[WebGLRenderingContext.CONSTANT_ALPHA]], or
    *   [[WebGLRenderingContext.ONE_MINUS_CONSTANT_ALPHA]]. This value is initially [[WebGLRenderingContext.ZERO]].
    * @param srcAlpha
    *   The source blending factor for Alpha. Accepted values are the same as srcRGB. The initial value is
    *   [[WebGLRenderingContext.ONE]].
    * @param dstAlpha
    *   The destination blending factor for Alpha. Accepted values are the same as srcRGB. The initial value is
  ...
  /** Sets the size of the bound [[WebGLBuffer]] for the given `target`. The contents of the buffer are cleared to 0.
    * @param target
    *   The target to resize. May be [[WebGLRenderingContext.ARRAY_BUFFER]] or
    *   [[WebGLRenderingContext.ELEMENT_ARRAY_BUFFER]].
    * @param size
    *   The size of the new buffer
    * @param usage
    *   The specified usage for this buffer. May be [[WebGLRenderingContext.STREAM_DRAW]],
    *   [[WebGLRenderingContext.STATIC_DRAW]] or [[WebGLRenderingContext.DYNAMIC_DRAW]].
    */
  def bufferData(target: Int, size: Int, usage: Int): Unit = js.native

  /** Resizes the bound [[WebGLBuffer]] for the given `target` to the size of the passed buffer, and replaces its
  ...
  /** Returns the completeness status for the framebuffer.
    ...
    *   - [[WebGLRenderingContext.FRAMEBUFFER_INCOMPLETE_ATTACHMENT]] - one or more attachment points are not complete
    *     in the framebuffer.
    *   - [[WebGLRenderingContext.FRAMEBUFFER_INCOMPLETE_DIMENSIONS]] - one or more attached images do not have a
    *     specified width and height.
    *   - [[WebGLRenderingContext.FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT]] - there are no images attached to the
    *     framebuffer.
    *   - [[WebGLRenderingContext.FRAMEBUFFER_UNSUPPORTED]] - the attached image format combinations are not supported
    *     on this platform.
    *
    * @param target
  ...
  /** Clears the buffers specified in `mask` with the current [[WebGLRenderingContext#clearColor]],
    * [[WebGLRenderingContext#clearDepth]] and [[WebGLRenderingContext#clearStencil]].
    *
    * @param mask
    *   The buffers to clear, a bitmask of one or more of [[WebGLRenderingContext.COLOR_BUFFER_BIT]],
    *   [[WebGLRenderingContext.DEPTH_BUFFER_BIT]] and [[WebGLRenderingContext.STENCIL_BUFFER_BIT]].
    */
  ...
  /** Loads a 2-dimensional texture into a texture unit, compressed with the specified algorithm.
    *
    * @param target
    *   the target on the active texture unit. May be [[WebGLRenderingContext.TEXTURE_2D]],
    *   [[WebGLRenderingContext.TEXTURE_CUBE_MAP_POSITIVE_X]], [[WebGLRenderingContext.TEXTURE_CUBE_MAP_NEGATIVE_X]],
  ...
  /** Loads a 2-dimensional texture subimage into a texture unit, compressed with the specified algorithm.
    ...
    *   the compressed image data.
    */
  def compressedTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int,
      data: ArrayBufferView): Unit = js.native
  ...
  /** Loads a 2-dimensional texture into a texture unit from the current framebuffer.
    ...
    *   the mipmap level of detail. 0 is the base image.
    * @param internalformat
    *   the format of the data. May be [[WebGLRenderingContext.ALPHA]], [[WebGLRenderingContext.LUMINANCE]],
    *   [[WebGLRenderingContext.LUMINANCE_ALPHA]], [[WebGLRenderingContext.RGB]], or [[WebGLRenderingContext.RGBA]].
    * @param x
    ...
    *   the border width. Must be 0.
    */
  def copyTexImage2D(target: Int, level: Int, internalformat: Int, x: Int, y: Int, width: Int, height: Int,
      border: Int): Unit = js.native
  ...
  /** Set the culling mode for front and back facing polygons.
    *
    * @param mode
    *   the culling mode, may be [[WebGLRenderingContext.FRONT]], [[WebGLRenderingContext.BACK]] or
    *   [[WebGLRenderingContext.FRONT_AND_BACK]]. When [[WebGLRenderingContext.FRONT_AND_BACK]] is set, no triangles are
    *   drawn, however lines and points will.
    */
  def cullFace(mode: Int): Unit = js.native

  /** Flags the specified [[WebGLBuffer]] for deletion. When it is no longer used by the WebGL system it will be
    * deleted.
    *
  ...
  /** Flags the specified [[WebGLFramebuffer]] for deletion. When it is no longer used by the WebGL system it will be
    * deleted.
    *
  ...
  /** Flags the specified [[WebGLProgram]] for deletion. When it is no longer used by the WebGL system it will be
    * deleted.
    *
  ...
  /** Flags the specified [[WebGLRenderbuffer]] for deletion. When it is no longer used by the WebGL system it will be
    * deleted.
    *
  ...
  /** Flags the specified [[WebGLShader]] for deletion. When it is no longer used by the WebGL system it will be
    * deleted.
    *
  ...
  /** Flags the specified [[WebGLTexture]] for deletion. When it is no longer used by the WebGL system it will be
    * deleted.
    *
  ...
  /** Set the function used to discard fragments. When depth testing is enabled, the fragment depth is compared with the
    * current depth, and is allowed onto the framebuffer.
    *
    * @param func
    *   the function to allow the fragment to be drawn. Values are [[WebGLRenderingContext.NEVER]],
    *   [[WebGLRenderingContext.LESS]], [[WebGLRenderingContext.EQUAL]], [[WebGLRenderingContext.LEQUAL]]
    *   [[WebGLRenderingContext.GREATER]], [[WebGLRenderingContext.NOTEQUAL]], [[WebGLRenderingContext.GEQUAL]], and
  ...
  /** Sets the mapping from normalized device coordinates to window coordinates. "normalized device coordinates" in this
    * context really means "normalized depth map values".
    *
  ...
  /** Disables a GL capability.
    ...
    *   [[WebGLRenderingContext.DEPTH_TEST]], [[WebGLRenderingContext.DITHER]],
    *   [[WebGLRenderingContext.POLYGON_OFFSET_FILL]], [[WebGLRenderingContext.SAMPLE_ALPHA_TO_COVERAGE]],
    *   [[WebGLRenderingContext.SAMPLE_COVERAGE]], [[WebGLRenderingContext.SCISSOR_TEST]], or
  ...
  /** Renders the primitives in the active arrays.
    *
    * @param mode
    *   the kind of primitives to render. May be [[WebGLRenderingContext.POINTS]], [[WebGLRenderingContext.LINES]],
    *   [[WebGLRenderingContext.LINE_STRIP]], [[WebGLRenderingContext.LINE_LOOP]], [[WebGLRenderingContext.TRIANGLES]],
    *   [[WebGLRenderingContext.TRIANGLE_STRIP]], [[WebGLRenderingContext.TRIANGLE_FAN]], or
  ...
  /** Renders the primitives in the active arrays using an [[WebGLRenderingContext.ELEMENT_ARRAY_BUFFER]] to index them.
    ...
    * @param type
    *   the type of index value in the [[WebGLRenderingContext.ELEMENT_ARRAY_BUFFER]]. May be
  ...
  /** Attach a [[WebGLRenderbuffer]] to a [[WebGLFramebuffer]].
    ...
    * @param attachment
    *   the attachment point on the framebuffer to attach the renderbuffer. May be
    *   [[WebGLRenderingContext.COLOR_ATTACHMENT0]], [[WebGLRenderingContext.DEPTH_ATTACHMENT]],
    ...
    */
  def framebufferRenderbuffer(target: Int, attachment: Int, renderbuffertarget: Int,
  ...
  /** Attach a [[WebGLTexture]] to a [[WebGLFramebuffer]].
    ...
    *   must be [[WebGLRenderingContext.FRAMEBUFFER]]
    * @param attachment
    *   the attachment point on the framebuffer to attach the texture. May be
    *   [[WebGLRenderingContext.COLOR_ATTACHMENT0]], [[WebGLRenderingContext.DEPTH_ATTACHMENT]],
    *   [[WebGLRenderingContext.STENCIL_ATTACHMENT]], or [[WebGLRenderingContext.DEPTH_STENCIL_ATTACHMENT]].
    * @param textarget
    *   the texture target. May be [[WebGLRenderingContext.TEXTURE_2D]],
    *   [[WebGLRenderingContext.TEXTURE_CUBE_MAP_POSITIVE_X]], [[WebGLRenderingContext.TEXTURE_CUBE_MAP_NEGATIVE_X]],
    *   [[WebGLRenderingContext.TEXTURE_CUBE_MAP_POSITIVE_Y]], [[WebGLRenderingContext.TEXTURE_CUBE_MAP_NEGATIVE_Y]],
    *   [[WebGLRenderingContext.TEXTURE_CUBE_MAP_POSITIVE_Z]], or [[WebGLRenderingContext.TEXTURE_CUBE_MAP_NEGATIVE_Z]]
    * @param texture
    ...
    */
  def framebufferTexture2D(target: Int, attachment: Int, textarget: Int, texture: WebGLTexture,
      level: Int): Unit = js.native
  ...
  /** Returns the value of the requested parameter for a buffer.
    ...
    * @param pname
    *   the buffer parameter to retrieve, may be [[WebGLRenderingContext.BUFFER_SIZE]] or
  ...
  /** Returns the value for the given `pname`. Returns a value who's type depends on the requested parameter.
    *
    * @param pname
    *   The parameter to query. May be [[WebGLRenderingContext.ACTIVE_TEXTURE]],
    *   [[WebGLRenderingContext.ALIASED_LINE_WIDTH_RANGE]], [[WebGLRenderingContext.ALIASED_POINT_SIZE_RANGE]],
    *   [[WebGLRenderingContext.ALPHA_BITS]], [[WebGLRenderingContext.ARRAY_BUFFER_BINDING]],
    *   [[WebGLRenderingContext.BLEND]], [[WebGLRenderingContext.BLEND_COLOR]],
    *   [[WebGLRenderingContext.BLEND_DST_ALPHA]], [[WebGLRenderingContext.BLEND_DST_RGB]],
    *   [[WebGLRenderingContext.BLEND_EQUATION_ALPHA]], [[WebGLRenderingContext.BLEND_EQUATION_RGB]],
    *   [[WebGLRenderingContext.BLEND_SRC_ALPHA]], [[WebGLRenderingContext.BLEND_SRC_RGB]],
    *   [[WebGLRenderingContext.BLUE_BITS]], [[WebGLRenderingContext.COLOR_CLEAR_VALUE]],
    *   [[WebGLRenderingContext.COLOR_WRITEMASK]], [[WebGLRenderingContext.COMPRESSED_TEXTURE_FORMATS]],
    *   [[WebGLRenderingContext.CULL_FACE]], [[WebGLRenderingContext.CULL_FACE_MODE]],
    *   [[WebGLRenderingContext.CURRENT_PROGRAM]], [[WebGLRenderingContext.DEPTH_BITS]],
    *   [[WebGLRenderingContext.DEPTH_CLEAR_VALUE]], [[WebGLRenderingContext.DEPTH_FUNC]], `DEPTH-RANGE`,
    *   [[WebGLRenderingContext.DEPTH_TEST]], [[WebGLRenderingContext.DEPTH_WRITEMASK]],
    *   [[WebGLRenderingContext.DITHER]], [[WebGLRenderingContext.ELEMENT_ARRAY_BUFFER_BINDING]],
    *   [[WebGLRenderingContext.FRAMEBUFFER_BINDING]], [[WebGLRenderingContext.FRONT_FACE]],
    *   [[WebGLRenderingContext.GENERATE_MIPMAP_HINT]], [[WebGLRenderingContext.GREEN_BITS]],
    *   [[WebGLRenderingContext.LINE_WIDTH]], [[WebGLRenderingContext.MAX_COMBINED_TEXTURE_IMAGE_UNITS]],
    *   [[WebGLRenderingContext.MAX_CUBE_MAP_TEXTURE_SIZE]], [[WebGLRenderingContext.MAX_FRAGMENT_UNIFORM_VECTORS]],
    *   [[WebGLRenderingContext.MAX_RENDERBUFFER_SIZE]], [[WebGLRenderingContext.MAX_TEXTURE_IMAGE_UNITS]],
    *   [[WebGLRenderingContext.MAX_TEXTURE_SIZE]], [[WebGLRenderingContext.MAX_VARYING_VECTORS]],
    *   [[WebGLRenderingContext.MAX_VERTEX_ATTRIBS]], [[WebGLRenderingContext.MAX_VERTEX_TEXTURE_IMAGE_UNITS]],
    *   [[WebGLRenderingContext.MAX_VERTEX_UNIFORM_VECTORS]], [[WebGLRenderingContext.MAX_VIEWPORT_DIMS]],
    *   [[WebGLRenderingContext.PACK_ALIGNMENT]], [[WebGLRenderingContext.POLYGON_OFFSET_FACTOR]],
    *   [[WebGLRenderingContext.POLYGON_OFFSET_FILL]], [[WebGLRenderingContext.POLYGON_OFFSET_UNITS]],
    *   [[WebGLRenderingContext.RED_BITS]], [[WebGLRenderingContext.RENDERBUFFER_BINDING]],
    *   [[WebGLRenderingContext.RENDERER]], [[WebGLRenderingContext.SAMPLE_BUFFERS]],
    *   [[WebGLRenderingContext.SAMPLE_COVERAGE_INVERT]], [[WebGLRenderingContext.SAMPLE_COVERAGE_VALUE]],
    *   [[WebGLRenderingContext.SAMPLES]], [[WebGLRenderingContext.SCISSOR_BOX]],
    *   [[WebGLRenderingContext.SCISSOR_TEST]], [[WebGLRenderingContext.SHADING_LANGUAGE_VERSION]],
    *   [[WebGLRenderingContext.STENCIL_BACK_FAIL]], [[WebGLRenderingContext.STENCIL_BACK_FUNC]],
    *   [[WebGLRenderingContext.STENCIL_BACK_PASS_DEPTH_FAIL]], [[WebGLRenderingContext.STENCIL_BACK_PASS_DEPTH_PASS]],
    *   [[WebGLRenderingContext.STENCIL_BACK_REF]], [[WebGLRenderingContext.STENCIL_BACK_VALUE_MASK]],
    *   [[WebGLRenderingContext.STENCIL_BACK_WRITEMASK]], [[WebGLRenderingContext.STENCIL_BITS]],
    *   [[WebGLRenderingContext.STENCIL_CLEAR_VALUE]], [[WebGLRenderingContext.STENCIL_FAIL]],
    *   [[WebGLRenderingContext.STENCIL_FUNC]], [[WebGLRenderingContext.STENCIL_PASS_DEPTH_FAIL]],
    *   [[WebGLRenderingContext.STENCIL_PASS_DEPTH_PASS]], [[WebGLRenderingContext.STENCIL_REF]],
    *   [[WebGLRenderingContext.STENCIL_TEST]], [[WebGLRenderingContext.STENCIL_VALUE_MASK]],
    *   [[WebGLRenderingContext.STENCIL_WRITEMASK]], [[WebGLRenderingContext.SUBPIXEL_BITS]],
    *   [[WebGLRenderingContext.TEXTURE_BINDING_2D]], [[WebGLRenderingContext.TEXTURE_BINDING_CUBE_MAP]],
    *   [[WebGLRenderingContext.UNPACK_ALIGNMENT]], [[WebGLRenderingContext.UNPACK_COLORSPACE_CONVERSION_WEBGL]],
    *   [[WebGLRenderingContext.UNPACK_FLIP_Y_WEBGL]], [[WebGLRenderingContext.UNPACK_PREMULTIPLY_ALPHA_WEBGL]],
    *   [[WebGLRenderingContext.VENDOR]], [[WebGLRenderingContext.VERSION]] or [[WebGLRenderingContext.VIEWPORT]].
    */
  ...
  /** Returns the error value, and resets the error to [[WebGLRenderingContext.NO_ERROR]].
    *
    * Only the first error is recorded, new errors are not stored until the error value is reset to
    * [[WebGLRenderingContext.NO_ERROR]] by a call to this method.
    *
    * @return
    *   the error code. One of [[WebGLRenderingContext.NO_ERROR]], [[WebGLRenderingContext.INVALID_ENUM]],
    *   [[WebGLRenderingContext.INVALID_VALUE]], [[WebGLRenderingContext.INVALID_OPERATION]],
    *   [[WebGLRenderingContext.INVALID_FRAMEBUFFER_OPERATION]], or [[WebGLRenderingContext.OUT_OF_MEMORY]].
    */
  def getError(): Int = js.native

  /** Returns the value for the given parameter name on for the target and attachment. The return type is dependent on
    * the requested parameter.
    *
    * @param target
    *   must be FRAMEBUFFER
    * @param attachment
    *   the attachment to examine. May be [[WebGLRenderingContext.COLOR_ATTACHMENT0]],
    ...
    * @param pname
    *   the framebuffer attachment parameter. May be [[WebGLRenderingContext.FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE]],
    *   [[WebGLRenderingContext.FRAMEBUFFER_ATTACHMENT_OBJECT_NAME]],
    *   [[WebGLRenderingContext.FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL]], or
  ...
  /** Returns the value for the given parameter name for the program. The return type is dependent on the requested
    * parameter.
    *
    * @param program
    *   the program to query.
    * @param pname
    *   the parameter to get, may be one of [[WebGLRenderingContext.DELETE_STATUS]],
    *   [[WebGLRenderingContext.LINK_STATUS]], [[WebGLRenderingContext.VALIDATE_STATUS]],
    *   [[WebGLRenderingContext.ATTACHED_SHADERS]], [[WebGLRenderingContext.ACTIVE_ATTRIBUTES]], or
  ...
  /** Returns the value of a parameter on the specified [[WebGLShader]]. The return type is dependent on the requested
    * parameter.
    *
    * @param shader
    *   the shader to query
    * @param pname
    *   the parameter to get, may be one of [[WebGLRenderingContext.SHADER_TYPE]],
  ...
  /** Returns a new [[WebGLShaderPrecisionFormat]] for the given shader type and precision type.
    ...
    * @param precisiontype
    *   the precision type to query, may be [[WebGLRenderingContext.LOW_FLOAT]], [[WebGLRenderingContext.MEDIUM_FLOAT]],
    *   [[WebGLRenderingContext.HIGH_FLOAT]], [[WebGLRenderingContext.LOW_INT]], [[WebGLRenderingContext.MEDIUM_INT]],
    *   or [[WebGLRenderingContext.HIGH_INT]].
    */
  ...
  /** Returns the value of the given texture parameter on the target of the active texture.
    ...
    * @param pname
    *   the parameter to query. May be either [[WebGLRenderingContext.TEXTURE_MAG_FILTER]],
    *   [[WebGLRenderingContext.TEXTURE_MIN_FILTER]], [[WebGLRenderingContext.TEXTURE_WRAP_S]], or
    *   [[WebGLRenderingContext.TEXTURE_WRAP_T]].
    */
  def getTexParameter(target: Int, pname: Int): js.Any = js.native

  /** Returns the value of the uniform in the given program and location. The return type is dependent on the uniform
    * type.
    */
  ...
  /** Specifies implementation specific hints.
    ...
    * @param mode
    *   the desired mode. Must be one of [[WebGLRenderingContext.FASTEST]], [[WebGLRenderingContext.NICEST]], or
  ...
  /** Sets the pixel store mode, used when copying image data such as framebuffers or textures.
    *
    * @param pname
    *   the property to change. May be one of [[WebGLRenderingContext.PACK_ALIGNMENT]],
    *   [[WebGLRenderingContext.UNPACK_ALIGNMENT]], [[WebGLRenderingContext.UNPACK_FLIP_Y_WEBGL]],
    *   [[WebGLRenderingContext.UNPACK_PREMULTIPLY_ALPHA_WEBGL]] or
  ...
  /** Specifies the polygon offset. When [[WebGLRenderingContext.POLYGON_OFFSET_FILL]] is enabled, depth values for a
    * fragment have an offset applied to them, calculated as `factor`*DZ + r*`units`, where DZ is the change in z based
  ...
  /** Reads pixels from the framebuffer into `pixels`.
    ...
    * @param format
    *   the format of the desired output. Must be one of [[WebGLRenderingContext.UNSIGNED_BYTE]],
    ...
    */
  def readPixels(x: Int, y: Int, width: Int, height: Int, format: Int, `type`: Int,
  ...
  /** Create renderbuffer image storage.
    ...
    *   must be [[WebGLRenderingContext.RENDERBUFFER]]
    * @param internalformat
    *   specifies the format of the renderbuffer. May be one of [[WebGLRenderingContext.RGBA4]],
    *   [[WebGLRenderingContext.RGB565]], [[WebGLRenderingContext.RGB5_A1]],
    *   [[WebGLRenderingContext.DEPTH_COMPONENT16]], [[WebGLRenderingContext.STENCIL_INDEX8]] or
  ...
  /** Sets the sampling coverage parameters for primitive antialiasing.
    *
    * The OpenGL multisampling algorithm is too involved to concisely explain here. Please consult
  ...
  /** Sets the scissor rectangle. When [[WebGLRenderingContext.SCISSOR_TEST]] is enabled, rendering will be restricted
    * to this rectangle.
    */
  ...
  /** Sets the stencil test for front and back faces.
    * @param func
    *   the test function. One of [[WebGLRenderingContext.NEVER]], [[WebGLRenderingContext.LESS]],
  ...
  /** Sets the stencil test for the given face type.
    * @param face
    *   the face(s) to configure the test for. May be [[WebGLRenderingContext.FRONT]], [[WebGLRenderingContext.BACK]] or
  ...
  /** Configure which bits in the stencil buffer may be written to by the given face type.
    * @param face
    *   the face(s) to configure the mask for. May be [[WebGLRenderingContext.FRONT]], [[WebGLRenderingContext.BACK]] or
    *   [[WebGLRenderingContext.FRONT_AND_BACK]].
    * @param mask
    *   the write mask. Set bits are allowed to be written to the corresponding stencil buffer bit.
    */
  ...
  /** Configure the effect of a stencil or depth test failing for front or back faces.
    *
    * @param fail
    *   the effect of the stencil test failing. May be one of [[WebGLRenderingContext.KEEP]],
    *   [[WebGLRenderingContext.ZERO]], [[WebGLRenderingContext.REPLACE]], [[WebGLRenderingContext.INCR]],
    *   [[WebGLRenderingContext.INCR_WRAP]], [[WebGLRenderingContext.DECR]], [[WebGLRenderingContext.DECR_WRAP]], and
  ...
  /** Configure the effect of a stencil or depth test failing for the specified faces.
    *
    * @param face
    *   the face(s) to configure the stencil operation for. May be [[WebGLRenderingContext.FRONT]],
    *   [[WebGLRenderingContext.BACK]] or [[WebGLRenderingContext.FRONT_AND_BACK]].
    * @param fail
    *   the effect of the stencil test failing. May be one of [[WebGLRenderingContext.KEEP]],
    *   [[WebGLRenderingContext.ZERO]], [[WebGLRenderingContext.REPLACE]], [[WebGLRenderingContext.INCR]],
    *   [[WebGLRenderingContext.INCR_WRAP]], [[WebGLRenderingContext.DECR]], [[WebGLRenderingContext.DECR_WRAP]], and
  ...
  /** Loads a 2-dimensional texture into a texture unit from source data.
    ...
    */
  def texImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: Int,
  ...
  /** Loads a 2-dimensional texture into a texture unit from an ImageData object.
    ...
    *   the source image data.
    */
  def texImage2D(target: Int, level: Int, internalformat: Int, format: Int, `type`: Int,
      pixels: ImageData): Unit = js.native
  ...
  /** Loads a 2-dimensional texture into a texture unit from an HTMLImageElement object.
    ...
    */
  def texImage2D(target: Int, level: Int, internalformat: Int, format: Int, `type`: Int,
      pixels: HTMLImageElement): Unit = js.native
  ...
  /** Loads a 2-dimensional texture into a texture unit from an HTMLCanvasElement object.
    ...
    */
  def texImage2D(target: Int, level: Int, internalformat: Int, format: Int, `type`: Int,
      pixels: HTMLCanvasElement): Unit = js.native
  ...
  /** Loads a 2-dimensional texture into a texture unit from an HTMLVideoElement object.
    ...
    */
  def texImage2D(target: Int, level: Int, internalformat: Int, format: Int, `type`: Int,
      pixels: HTMLVideoElement): Unit = js.native

  /** Sets the texture parameter for the active texture unit.
    *
    * @param target
    *   the texture target to configure. May be [[WebGLRenderingContext.TEXTURE_2D]] or
    *   [[WebGLRenderingContext.TEXTURE_CUBE_MAP]]
    * @param pname
    *   the parameter to change. May be [[WebGLRenderingContext.TEXTURE_MIN_FILTER]],
    *   [[WebGLRenderingContext.TEXTURE_MAG_FILTER]] [[WebGLRenderingContext.TEXTURE_WRAP_S]], or
    *   [[WebGLRenderingContext.TEXTURE_WRAP_T]]
    * @param param
  ...
  /** Loads a 2-dimensional texture subimage into a texture unit from an `ArrayBufferView`.
    ...
    *   the image data.
    */
  def texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int,
      `type`: Int, pixels: ArrayBufferView): Unit = js.native
  ...
  /** Loads a 2-dimensional texture subimage into a texture unit from an `ImageData` object.
    ...
    *   the image data.
    */
  def texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, format: Int, `type`: Int,
      pixels: ImageData): Unit = js.native
  ...
  /** Defines an array of generic vertex attribute data.
    ...
    * @param type
    *   the datatype for each component, may be [[WebGLRenderingContext.BYTE]], [[WebGLRenderingContext.UNSIGNED_BYTE]],
    *   [[WebGLRenderingContext.SHORT]], [[WebGLRenderingContext.UNSIGNED_SHORT]], or [[WebGLRenderingContext.FLOAT]].
    * @param normalized
